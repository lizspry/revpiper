...
| Joins disposition in the spec step's audit/run commands | Task 17 walkthrough (Phase 1) | **Resolved 2026-07-12** (amendment 9d: TRUE/FALSE `joins` parameter — TRUE + no joins.yaml errors, FALSE skips without warning; disposition always stated on report + certificate; only the default, FALSE incumbent, left to the walkthrough) |
