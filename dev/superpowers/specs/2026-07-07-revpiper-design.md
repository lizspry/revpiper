...
| Joins declaring expected column overlap between sides (`shared:`); overlap semantics differ between same-variables merges and different-information merges | Task 5 walkthrough (Phase 1) | Open (flagged 2026-07-11) |
| Workflow ordering: within-source data checking + corrections vs across-source post-join checking + corrections; join spec may be authored upfront so sheets are set up compatibly | Phase 2 planning (corrections engine) | Open (flagged 2026-07-11) |
