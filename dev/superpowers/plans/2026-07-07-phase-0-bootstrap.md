...
- [ ] **Step 7: exit checklist.** CI green on main; site live; badges render; branch protection intact; local folder renamed (Step 6). Then Phase 1 planning (opens with the extraction-tool export investigation + data-dict format decision, spec §8.2/§8.4).
